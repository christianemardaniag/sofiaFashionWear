    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="ordersadmin.php">Orders</a>
          </li>
          <li class="nav-item">
            ...
            while ($row = mysqli_fetch_array($sql, MYSQLI_ASSOC)) {
              ...
              <tr>
                ...
                <?php if ($orderstatus == "PENDING") {
                  ...
                  ?></td>
                <td style="width: 40vh; text-align:center;vertical-align:middle; <?php if ($orderstatus == "PENDING") {
                                                                                    echo 'color: #cf550e;';
                                                                                  } else if ($orderstatus == "CLAIMED") {
                                                                                    echo 'color:green;';
                                                                                  } else if ($orderstatus == "CANCELLED") {
