    ...
    <div class="col-12 overflow-auto" style="height: 50vh; background-color: #f2f2f2;">
        ...
        <div class="d-flex flex-column-reverse">
            <div class="align-self-end">
              <?php
                if($counter > 0){
                  echo '<button style="vertical-align:middle; margin-top: 10px; margin-bottom: 10px; width: 30vh;" type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#checkOut">Checkout</button>';
                }
              ?>
            </div>
        </div>
