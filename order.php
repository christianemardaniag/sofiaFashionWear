        ...
        <ul class="navbar-nav mb-2 mb-lg-0">
          <div class="input-group">
            ...
            <li class="nav-item" title="Cart">
              <a class="nav-link me-2" href="mycart.php" role="button">
        ...
        <form action="order.php" method="GET">
          <div class="input-group mb-5">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="padding: 2vh">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="category" value="Tops">
                <label class="form-check-label" for="category">
                  Tops
                </label>
              </div>
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="category" value="Accessories">
                <label class="form-check-label" for="category">
                  Accessories
                </label>
              </div>
              ...
              <div class="input-group input-group-sm mb-3">
                <input type="number" min="0" class="form-control" name="low" id="low" style="width: 1vh" placeholder="Lowest" onchange onpropertychange onkeyuponpaste oninput="priceRange('Low')">
                <input type="number" min="0" class="form-control" name="high" id="high" placeholder="Highest" onchange onpropertychange onkeyuponpaste oninput="priceRange('High')">
              </div>
            </div>
  ...
  <div class="container">
    <div class="row">
      ...
      while ($row = mysqli_fetch_array($sql, MYSQLI_ASSOC)) {
        ...
        $frontpath = $row['front_image'];
        $backpath = $row['back_image'];
        $sm = $row['small'];
        $md = $row['medium'];
        $lg = $row['large'];
        $counter++;
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 d-flex justify-content-center mb-5">
          <div id="containers">
            <div class="col-3">
             ...
             value='$id' class='btn btn-warning' data-bs-toggle='modal' data-bs-target='#addModal'>Add to cart</button>";
                  } else {
                    echo "<a href='' data-bs-toggle='modal' data-bs-target='#exampleModalCenter' class='mt-3'>Add to Cart</a>";
                  }
                  ?>
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-5 p-4 modal-body">
          <div id="carouselExampleControls" class="carousel" data-ride="carousel">
            <div class="carousel-inner" style="height: 38vh; align-items: center">
        ...
        <div class="col-7 p-4 modal-body">
          <form action="executionFile/addcart.php" method="POST">
            ...
            <div class="input-group mb-3">
              <input type="number" class="form-control" id="qtyy" min="1" name="qty" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" value="0" onchange onpropertychange onkeyuponpaste oninput="total()">
            </div>
