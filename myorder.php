              ...
              <tr>
                ...
                <td>
                  ...
                  if ($orderstatus == "CLAIMED" && $rated == "NOT") {
                    ...
                    echo '<button style="vertical-align:middle; width: 20vh; margin-top: 5px;" type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#cancelModal">Details</button>';
                  } else {
                    echo '<button  onclick="getIDs(this)" value=' . $orid . ' style="vertical-align:middle; width: 20vh; margin-top: 5px;" type="button" class="openupModal btn btn-warning" data-bs-toggle="modal" data-bs-target="#cancelOrdModal">Cancel Order</button>';
                  }
                  ?>
...
<div class="modal fade" id="doneModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-info mb-3" role="alert">
          This order claimed succesfully, Thank you for supporting our business!
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" data-bs-dismiss="modal" class="btn btn-secondary">Close</button>
